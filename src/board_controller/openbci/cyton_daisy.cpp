    ...
    while (keep_alive)
    {
        ...
        if (first_sample)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                safe_logger(spdlog::level::info, "GAIN CHECK {} {}", i + 8, gain_tracker.get_gain_for_channel(i));
        ...
        else
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                double eeg_scale = (double)(4.5 / float ((pow (2, 23) - 1)) /
                    ...
                    safe_logger(spdlog::level::info, "GAIN CHECK {} {}", (i), gain_tracker.get_gain_for_channel(i + 8));
